        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="page-title-item text-center">
                    <h2 class="title">Personnaliser vos Tacos - {{ request('type') == 'menu' ? 'Menu' : 'Seul' }}</h2>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('front.index')}}"><i class="flaticon-home"></i>{{__('Home')}}</a></li>
                            <li class="breadcrumb-item"><a href="{{route('front.tacos')}}">Nos Tacos</a></li>
                    ...
                    @foreach($addons as $category => $addonData)
                        @if($addonData['items']->count() > 0)
                            <div class="addon-category" style="background: #2c3e50; border-radius: 20px; padding: 30px; margin-bottom: 30px; box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
                                <h2 style="color: #27ae60; font-size: 2rem; font-weight: 700; margin-bottom: 15px; text-align: center;">
                                    @if($category == 'sauces')
                                ...
                                <p style="color: #bdc3c7; text-align: center; font-size: 0.9rem; margin-bottom: 20px; font-style: italic;">
