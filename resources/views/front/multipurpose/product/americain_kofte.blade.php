                    ...
                    <div class="menu-table" style="background: rgba(255,255,255,0.1); border-radius: 15px; padding: 20px;">
                        ...
                        <div class="menu-item" style="display: grid; grid-template-columns: 2fr 1fr 1fr 1fr; gap: 20px; align-items: center; padding: 15px 0; border-bottom: 1px solid rgba(255,255,255,0.2);">
                            ...
                            <div style="text-align: center;">
                                <button onclick="openCustomizationModal(131, 'AMERICAIN', '7,50', 'Seul', false, false)" class="btn btn-warning btn-sm" style="background: #e74c3c; border: none; color: white; padding: 8px 16px; border-radius: 20px; font-weight: 600; transition: all 0.3s ease; margin-bottom: 8px; width: 100%;">
                                    <i class="fas fa-cog" style="margin-right: 5px;"></i>
                                    Seul
                                </button>
                                <button onclick="openCustomizationModal(131, 'AMERICAIN', '10,50', 'Menu', false, true)" class="btn btn-warning btn-sm" style="background: #c0392b; border: none; color: white; padding: 8px 16px; border-radius: 20px; font-weight: 600; transition: all 0.3s ease; width: 100%;">
                                    <i class="fas fa-cog" style="margin-right: 5px;"></i>
                                    Menu
                                </button>
                            </div>
                        ...
                        <div class="menu-item" style="display: grid; grid-template-columns: 2fr 1fr 1fr 1fr; gap: 20px; align-items: center; padding: 15px 0;">
                            ...
                            <span style="color: white; font-weight: 600; font-size: 1.2rem; text-align: center;">10,50€</span>
                            <div style="text-align: center;">
                                <button onclick="openCustomizationModal(132, 'KOFTE', '7,50', 'Seul', false, false)" class="btn btn-warning btn-sm" style="background: #e74c3c; border: none; color: white; padding: 8px 16px; border-radius: 20px; font-weight: 600; transition: all 0.3s ease; margin-bottom: 8px; width: 100%;">
                                    <i class="fas fa-cog" style="margin-right: 5px;"></i>
                                    Seul
                                </button>
                                <button onclick="openCustomizationModal(132, 'KOFTE', '10,50', 'Menu', false, true)" class="btn btn-warning btn-sm" style="background: #c0392b; border: none; color: white; padding: 8px 16px; border-radius: 20px; font-weight: 600; transition: all 0.3s ease; width: 100%;">
                                    <i class="fas fa-cog" style="margin-right: 5px;"></i>
                                    Menu
                                </button>
                            </div>
            ...
            <div class="col-lg-4">
                <div class="food-images" style="position: sticky; top: 20px;">
                    ...
                    <div class="food-item" style="margin-bottom: 30px; text-align: center;">
                        ...
                        <h4 style="color: #2c3e50; font-weight: 600; margin: 0;">Americain Classique</h4>
                        <p style="color: #7f8c8d; margin: 5px 0 0 0; font-size: 0.9rem;">Steak haché et fromage</p>
                    </div>

                    <!-- Kofte Image -->
                    <div class="food-item" style="text-align: center;">
                        <div class="image-container" style="position: relative; margin-bottom: 20px;">
                            <div class="food-image" style="width: 100%; height: 200px; background: linear-gradient(45deg, #d35400, #e67e22); border-radius: 20px; display: flex; align-items: center; justify-content: center; box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
                                <i class="fas fa-drumstick-bite" style="font-size: 4rem; color: white;"></i>
                            </div>
                            <div class="glow-effect" style="position: absolute; top: -10px; left: -10px; right: -10px; bottom: -10px; background: radial-gradient(circle, rgba(231,76,60,0.3) 0%, transparent 70%); border-radius: 25px; z-index: -1;"></div>
                        </div>
                        <h4 style="color: #2c3e50; font-weight: 600; margin: 0;">Kofte Épicé</h4>
                        <p style="color: #7f8c8d; margin: 5px 0 0 0; font-size: 0.9rem;">Boulettes de viande épicées</p>
                    </div>
                    ...
                    <div class="info-section" style="background: linear-gradient(45deg, #34495e, #2c3e50); border-radius: 20px; padding: 25px; margin-top: 30px; box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
                        <h4 style="color: #e74c3c; font-weight: 700; margin-bottom: 20px; text-align: center; font-size: 1.3rem;">
                        ...
                        <div class="info-item" style="background: rgba(255,255,255,0.1); border-radius: 15px; padding: 15px; margin-bottom: 15px; text-align: center;">
                            <i class="fas fa-clock" style="color: #e74c3c; font-size: 1.5rem; margin-bottom: 10px;"></i>
                        ...
                        <div class="info-item" style="background: rgba(255,255,255,0.1); border-radius: 15px; padding: 15px; text-align: center;">
                            ...
                            <h5 style="color: white; font-weight: 600; margin: 10px 0; font-size: 1.1rem;">Recettes traditionnelles</h5>
                            <p style="color: #bdc3c7; margin: 0; font-size: 0.9rem;">Saveurs authentiques</p>
                        </div>
                    </div>
                </div>
            </div>
...
function openCustomizationModal(productId, productName, price, type, hasMeat, isMenu) {
    ...
    if (typeof window.currentCustomizationOptions !== 'undefined') {
        window.currentCustomizationOptions.productType = 'sandwiches';
