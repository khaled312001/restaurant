...
<!-- Page Header -->
<div class="page-header" style="background: linear-gradient(135deg, #e67e22 0%, #f39c12 100%); padding: 60px 0; text-align: center; color: white;">
    <div class="container">
        ...
        <p style="font-size: 1.2rem; opacity: 0.9; margin: 0;">
            Découvrez nos délicieux burgers préparés avec des ingrédients frais et authentiques
        </p>
    </div>
</div>
