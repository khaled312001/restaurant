                    ...
                    <div class="menu-table" style="background: rgba(255,255,255,0.1); border-radius: 15px; padding: 20px;">
                        ...
                        <div class="menu-item desktop-only" style="display: grid; grid-template-columns: 2fr 1fr 1fr; gap: 15px; align-items: center; padding: 15px 0; border-bottom: 1px solid rgba(255,255,255,0.2);">
                            ...
                            <div style="text-align: center;">
                                <button onclick="addToCartSimple('{{ route('add.cart', 60) }}')" class="btn btn-warning btn-sm" style="background: #f39c12; border: none; color: white; padding: 8px 16px; border-radius: 20px; font-weight: 600; transition: all 0.3s ease;">
                        ...
                        <div class="menu-item-mobile mobile-only" style="background: rgba(255,255,255,0.05); border-radius: 15px; padding: 20px; margin-bottom: 15px; border: 1px solid rgba(255,255,255,0.1);">
                            ...
                            <div style="text-align: center;">
                                <button onclick="addToCartSimple('{{ route('add.cart', 60) }}')" class="btn btn-warning" style="background: #f39c12; border: none; color: white; padding: 12px 24px; border-radius: 25px; font-weight: 600; transition: all 0.3s ease; width: 100%; font-size: 1rem;">
                        ...
                        <div class="menu-item desktop-only" style="display: grid; grid-template-columns: 2fr 1fr 1fr; gap: 15px; align-items: center; padding: 15px 0; border-bottom: 1px solid rgba(255,255,255,0.2);">
                            ...
                            <div style="text-align: center;">
                                <button onclick="addToCartSimple('{{ route('add.cart', 61) }}')" class="btn btn-warning btn-sm" style="background: #f39c12; border: none; color: white; padding: 8px 16px; border-radius: 20px; font-weight: 600; transition: all 0.3s ease;">
                                    <i class="fas fa-shopping-cart" style="margin-right: 5px;"></i>
                                    Commander
                                </button>
                            </div>
                        ...
                        <div class="menu-item-mobile mobile-only" style="background: rgba(255,255,255,0.05); border-radius: 15px; padding: 20px; margin-bottom: 15px; border: 1px solid rgba(255,255,255,0.1);">
                            ...
                            <div style="text-align: center;">
                                <button onclick="addToCartSimple('{{ route('add.cart', 61) }}')" class="btn btn-warning" style="background: #f39c12; border: none; color: white; padding: 12px 24px; border-radius: 25px; font-weight: 600; transition: all 0.3s ease; width: 100%; font-size: 1rem;">
                                    <i class="fas fa-shopping-cart" style="margin-right: 8px;"></i>
                                    Commander
                                </button>
                            </div>
                        ...
                        <div class="menu-item desktop-only" style="display: grid; grid-template-columns: 2fr 1fr 1fr; gap: 15px; align-items: center; padding: 15px 0; border-bottom: 1px solid rgba(255,255,255,0.2);">
                            ...
                            <div style="text-align: center;">
                                <button onclick="addToCartSimple('{{ route('add.cart', 62) }}')" class="btn btn-warning btn-sm" style="background: #f39c12; border: none; color: white; padding: 8px 16px; border-radius: 20px; font-weight: 600; transition: all 0.3s ease;">
                                    <i class="fas fa-shopping-cart" style="margin-right: 5px;"></i>
                                    Commander
                                </button>
                            </div>
                        ...
                        <div class="menu-item-mobile mobile-only" style="background: rgba(255,255,255,0.05); border-radius: 15px; padding: 20px; margin-bottom: 15px; border: 1px solid rgba(255,255,255,0.1);">
                            ...
                            <div style="text-align: center;">
                                <button onclick="addToCartSimple('{{ route('add.cart', 62) }}')" class="btn btn-warning" style="background: #f39c12; border: none; color: white; padding: 12px 24px; border-radius: 25px; font-weight: 600; transition: all 0.3s ease; width: 100%; font-size: 1rem;">
                                    <i class="fas fa-shopping-cart" style="margin-right: 8px;"></i>
                                    Commander
                                </button>
                            </div>
                        ...
                        <div class="menu-item desktop-only" style="display: grid; grid-template-columns: 2fr 1fr 1fr; gap: 15px; align-items: center; padding: 15px 0;">
                            ...
                            <div style="text-align: center;">
                                <button onclick="addToCartSimple('{{ route('add.cart', 63) }}')" class="btn btn-warning btn-sm" style="background: #f39c12; border: none; color: white; padding: 8px 16px; border-radius: 20px; font-weight: 600; transition: all 0.3s ease;">
                                    <i class="fas fa-shopping-cart" style="margin-right: 5px;"></i>
                                    Commander
                                </button>
                            </div>
                        ...
                        <div class="menu-item-mobile mobile-only" style="background: rgba(255,255,255,0.05); border-radius: 15px; padding: 20px; margin-bottom: 15px; border: 1px solid rgba(255,255,255,0.1);">
                            ...
                            <div style="text-align: center;">
                                <button onclick="addToCartSimple('{{ route('add.cart', 63) }}')" class="btn btn-warning" style="background: #f39c12; border: none; color: white; padding: 12px 24px; border-radius: 25px; font-weight: 600; transition: all 0.3s ease; width: 100%; font-size: 1rem;">
                                    <i class="fas fa-shopping-cart" style="margin-right: 8px;"></i>
                                    Commander
                                </button>
                            </div>
                ...
                <div class="menu-category" style="background: #2c3e50; border-radius: 20px; padding: 30px; box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
                    ...
                    <div class="info-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
                        <div class="info-item" style="background: rgba(255,255,255,0.1); padding: 20px; border-radius: 15px; text-align: center;">
                            <i class="fas fa-bread-slice" style="font-size: 2.5rem; color: #f39c12; margin-bottom: 15px; display: block;"></i>
                            <h4 style="color: white; margin-bottom: 10px;">Pain Frais</h4>
                            <p style="color: white; opacity: 0.9; margin: 0; font-size: 0.9rem;">Pain frais grillé à la perfection</p>
                        </div>
                        <div class="info-item" style="background: rgba(255,255,255,0.1); padding: 20px; border-radius: 15px; text-align: center;">
                        ...
                        <div class="info-item" style="background: rgba(255,255,255,0.1); padding: 20px; border-radius: 15px; text-align: center;">
                            <i class="fas fa-fire" style="font-size: 2.5rem; color: #f39c12; margin-bottom: 15px; display: block;"></i>
                            <h4 style="color: white; margin-bottom: 10px;">Grillés Chauds</h4>
                            <p style="color: white; opacity: 0.9; margin: 0; font-size: 0.9rem;">Panini grillés chauds et croustillants</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="product-cards" style="position: sticky; top: 20px;">
                    ...
                    <div class="product-card" style="margin-bottom: 30px; text-align: center;">
                        ...
                        <h4 style="color: #2c3e50; font-weight: 600; margin: 0;">Panini 3 Fromages</h4>
                        <p style="color: #7f8c8d; margin: 5px 0 0 0; font-size: 0.9rem;">Trois fromages fondus</p>
                    </div>
                    ...
                    <div class="product-card" style="text-align: center;">
                        ...
                        <h4 style="color: #2c3e50; font-weight: 600; margin: 0;">Panini Kebab</h4>
                        <p style="color: #7f8c8d; margin: 5px 0 0 0; font-size: 0.9rem;">Kebab grillé</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="cta-section" style="padding: 80px 0; background: linear-gradient(135deg, #f39c12 0%, #e67e22 100%); text-align: center; color: white;">
    <div class="container">
        <h2 style="font-size: 2.5rem; font-weight: 700; margin-bottom: 20px;">
            Prêt à déguster nos panini ?
        </h2>
        <p style="font-size: 1.2rem; margin-bottom: 30px; opacity: 0.9;">
            Commandez maintenant et profitez de nos panini grillés
        </p>
